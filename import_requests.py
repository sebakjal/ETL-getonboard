...
# Debido a que es una base de datos relativamente pequeña se decide tener todas las columnas en una sola tabla denormalizada,
# además de ser una configuración óptima para BigQuery
